...
public class Main {
    ...
    public static void cargaProductos(ArrayList <Producto> productos) {
    	...
    	productos.add(new Producto("P88", "Procesador Ryzen 7 AMD", 784458.53, categoria.INFORMATICA, origenFabricacion.CHINA, true));
    	productos.add(new Producto("H7", "Impresora HP", 164854.0, categoria.INFORMATICA, origenFabricacion.CHINA, true));
    	productos.add(new Producto("H4", "Impresora Brother", 532465.02, categoria.INFORMATICA, origenFabricacion.CHINA, true));
    	productos.add(new Producto("H88", "Impresora kodek", 654458.53, categoria.INFORMATICA, origenFabricacion.CHINA, true));
    }
